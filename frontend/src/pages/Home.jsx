...
const Home = () => {
  ...
  useEffect(() => {
    ...
    handleScroll(); // Set initial scroll state on load
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      {/* Content starts below the fixed Navbarold */}
      <div className={`${isScrolled ? "mt-[80px]" : ""}`}>
        <Hero />

        <div className="px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]">
          <LatestCollection />

          {/* Vermicompost Benefits Section */}
          <motion.section
          ...
          {/* NewsletterBox (uncomment if used) */}
          {/* <motion.section
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
